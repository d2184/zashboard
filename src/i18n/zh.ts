...
const zh: LANG_MESSAGE = {
  ...
  earthDatabaseConsent:
    '所有连接端点都只在此浏览器中查询。DB-IP City Lite 下载约需 {download}，解压后约占 {stored} 本地存储空间。',
  earthDatabaseCacheRecovered: '已移除损坏的数据库缓存，请下载完整副本以恢复定位。',
  earthDatabaseDownload: '下载数据库',
  earthDatabaseLearnMore: '了解 DB-IP City Lite',
  earthDatabaseDownloading: '正在下载城市数据库',
  earthDatabaseError_space: '浏览器可用存储空间不足，无法保存城市数据库。',
  earthDatabaseError_network: '城市数据库下载失败。',
  earthDatabaseError_decompress: '城市数据库解压失败。',
  earthDatabaseError_invalid: '下载的城市数据库无效。',
  earthDatabaseError_storage: '无法将城市数据库保存到浏览器存储。',
  earthDatabaseError_unsupported: '当前浏览器无法解压城市数据库。',
  earthDatabaseError_unknown: '无法加载城市数据库。',
  earthOriginError: '无法探测本机公网 IP，请重试后再定位连接。',
  earthNoConnections: '暂无活跃连接',
  earthNoLocatedConnections: '无法定位当前活跃连接的端点',
  earthEndpointRole: '角色',
  earthTopDownloadedHosts: '下载量 Top 5 Host',
  earthRole_origin: '本机',
  earthRole_destination: '目的地',
  earthRendererError: '当前浏览器无法使用 3D 渲染。',
  retry: '重试',
