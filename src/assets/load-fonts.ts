...
export const loadFonts = () => {
  ...
  } else if (import.meta.env.MODE === FONTS.MI_SANS) {
    import('subsetted-fonts/MiSans-VF/MiSans-VF.css')
  } else if (import.meta.env.MODE === FONTS.SARASA_UI) {
    import('subsetted-fonts/SarasaUiSC-Regular/SarasaUiSC-Regular.css')
  } else if (import.meta.env.MODE === FONTS.PING_FANG) {
    import('subsetted-fonts/PingFangSC-Regular/PingFangSC-Regular.css')
  } else if (import.meta.env.MODE === FONTS.FIRA_SANS) {
    import('@fontsource/fira-sans/index.css')
  } else if (import.meta.env.MODE === FONTS.SYSTEM_UI) {
  } else {
    import('@fontsource/fira-sans/index.css')
    import('subsetted-fonts/MiSans-VF/MiSans-VF.css')
    import('subsetted-fonts/SarasaUiSC-Regular/SarasaUiSC-Regular.css')
